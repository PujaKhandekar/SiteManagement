...
public class Sitecontract {
	...
	public Sitecontract(int sitecontramatid, String companyname, String sitename, String contra_mat, String sitefixamt,
			double available_balance, String startdate, String enddate, Date creatdate) {
		super();
	...
	public String toString() {
		return "Sitecontract [sitecontramatid=" + sitecontramatid + ", companyname=" + companyname + ", sitename="
				...
				+ available_balance + ", startdate=" + startdate + ", enddate=" + enddate + "]";
	}
